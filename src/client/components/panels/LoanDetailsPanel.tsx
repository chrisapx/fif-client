...
const LoanDetailsPanel = () => {
  ...
  // Note: Document, collateral, and notes features are not available in self-service API
  // These are admin-only features available at /api/v1/loans (staff endpoints)
          ...
          <section className='overflow-y-auto'>
            ...
            <section className='mt-12 mb-16'>
              ...
              <div className='px-2 py-3'>
                ...
                <p className='text-sm'>{loan?.loanName || loanDetails?.externalId || loanDetails?.accountNo || loanDetails?.loanProductName || '--'}</p>
              </div>
